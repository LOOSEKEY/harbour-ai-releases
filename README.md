<!-- NOTE: the direct-download links below are version-pinned (HARBOUR-AI-1.1.1.*).
...
[![Version](https://img.shields.io/badge/version-1.1.1-16a34a?style=flat-square)](https://github.com/LOOSEKEY/harbour-ai-releases/releases/latest)
...
| Windows | Linux | macOS |
|:---:|:---:|:---:|
| [**Download installer (.exe)**](https://github.com/LOOSEKEY/harbour-ai-releases/releases/latest/download/HARBOUR-AI-1.1.1-Setup.exe) | [**Download AppImage**](https://github.com/LOOSEKEY/harbour-ai-releases/releases/latest/download/HARBOUR-AI-1.1.1.AppImage) | *Coming soon* |
| [Portable .exe](https://github.com/LOOSEKEY/harbour-ai-releases/releases/latest/download/HARBOUR-AI-1.1.1-Portable.exe) | [.deb package](https://github.com/LOOSEKEY/harbour-ai-releases/releases/latest/download/HARBOUR-AI-1.1.1.deb) | |
