<!-- NOTE: the direct-download links below are version-pinned (HARBOUR-AI-1.0.141.*).
...
[![Version](https://img.shields.io/badge/version-1.0.141-16a34a?style=flat-square)](https://github.com/LOOSEKEY/harbour-ai-releases/releases/latest)
...
| Windows | Linux | macOS |
|:---:|:---:|:---:|
| [**Download installer (.exe)**](https://github.com/LOOSEKEY/harbour-ai-releases/releases/latest/download/HARBOUR-AI-1.0.141-Setup.exe) | [**Download AppImage**](https://github.com/LOOSEKEY/harbour-ai-releases/releases/latest/download/HARBOUR-AI-1.0.141.AppImage) | *Coming soon* |
| [Portable .exe](https://github.com/LOOSEKEY/harbour-ai-releases/releases/latest/download/HARBOUR-AI-1.0.141-Portable.exe) | [.deb package](https://github.com/LOOSEKEY/harbour-ai-releases/releases/latest/download/HARBOUR-AI-1.0.141.deb) | |
